const OPERACIONES = {
  ...
  const obtenerResumenPorMeses = (operaciones) => {
    const resumen = {
      mayorGanancia: {
        fecha: "",
        monto: 0
  ...
  const obtenerResumenPorCategorias = (operaciones, categorias) => {
    const resumen = {
      mayorGanancia: {
        categoria: "",
        monto: 0
  ...
  const obtenerResumen = (operaciones, categorias) => {
    const resumenPorCategorias = obtenerResumenPorCategorias(operaciones, categorias);
    const resumenPorMeses = obtenerResumenPorMeses(operaciones);
    return {
      meses: { ...resumenPorMeses },
      categorias: resumenPorCategorias,
    };
  };
